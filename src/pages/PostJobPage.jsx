...
const PostJobPage = () => {
 ...
 setError("Please specify a Date, Start Time, and End Time for the job.");
 return;
 }
 ...
 className="flex-1 bg-white border border-slate-200 text-slate-700 font-bold py-3.5 px-4 rounded-xl text-xs shadow-sm flex items-center justify-center gap-1.5 cursor-pointer touch-target"
 >
 {locationLoading ? (
 <>
 ...
 disabled={locationLoading}
 className="flex-1 bg-primary text-white font-bold py-3.5 px-4 rounded-xl text-xs shadow-sm flex items-center justify-center gap-1.5 cursor-pointer touch-target"
 >
 <Search size={16} />
 ...
 {/* Job Time Slots Picker */}
 <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
 <div>
 <label htmlFor="jobDate" className="block text-xs font-bold text-slate-700 mb-1.5 uppercase">
 Job Date
 </label>
 <input
 id="jobDate"
 ...
 <div>
 <label htmlFor="startTime" className="block text-xs font-bold text-slate-700 mb-1.5 uppercase">
 Start Time
 </label>
 <input
 id="startTime"
 ...
 <div>
 <label htmlFor="endTime" className="block text-xs font-bold text-slate-700 mb-1.5 uppercase">
 End Time
 </label>
 <input
 id="endTime"
 ...
 className="w-full bg-primary text-white font-bold py-3.5 rounded-xl text-xs shadow-sm touch-target flex items-center justify-center mt-3 disabled:bg-slate-100 disabled:text-slate-400 disabled:border-slate-200 disabled:cursor-not-allowed border border-transparent"
 >
 {loading 
 ? t('creatingPost') 
 : !currentUser.verified 
