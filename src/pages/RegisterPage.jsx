...
const RegisterPage = () => {
 ...
 className="border-2 border-slate-200 p-6 rounded-2xl flex flex-col items-center gap-3 text-center bg-white touch-target group cursor-pointer"
 >
 <div className="w-12 h-12 rounded-full bg-slate-100 group- flex items-center justify-center text-slate-500 group-">
 <UserCheck size={24} />
 </div>
 <div>
 ...
 className="bg-primary text-white font-bold px-4 rounded-xl text-xs touch-target cursor-pointer"
 >
 Send OTP
 </button>
 )}
 ...
 className="bg-primary text-white font-bold px-4 rounded-lg text-xs"
 >
 Verify OTP
 </button>
 </div>
 ...
 className="bg-white border border-red-200 text-red-700 font-bold px-4 py-2.5 rounded-xl text-xs shadow-sm cursor-pointer flex-1"
 >
 Enable Location
 </button>
 <button
 ...
 className="bg-red-600 text-white font-bold px-4 py-2.5 rounded-xl text-xs shadow-sm cursor-pointer flex-1"
 >
 Choose Location
 </button>
 </div>
 ...
 type="button"
 onClick={requestDeviceLocation}
 className="bg-primary text-white font-bold px-4 py-2.5 rounded-xl text-xs shadow-sm cursor-pointer flex-1"
 >
 Enable Location
 </button>
 <button
 type="button"
 onClick={() => setIsLocationModalOpen(true)}
 className="bg-white border border-slate-200 text-slate-700 font-bold px-4 py-2.5 rounded-xl text-xs shadow-sm cursor-pointer flex-1"
 >
 Choose Location
 </button>
 </div>
 ...
 className={`text-left p-2.5 rounded-lg border text-xs font-semibold flex items-center justify-between cursor-pointer ${
 isChecked 
 ...
 type="button"
 onClick={() => setStep(1)}
 className="flex-1 border border-slate-200 font-bold py-3.5 rounded-xl text-xs text-slate-700 text-center touch-target cursor-pointer"
 >
 {t('back')}
 </button>
 <button
 type="submit"
 className="flex-1 bg-primary text-white font-bold py-3.5 rounded-xl text-xs shadow-sm touch-target cursor-pointer"
 >
 ...
 <label className="flex-1 cursor-pointer flex flex-col items-center justify-center gap-2 p-4 border border-slate-200 bg-white rounded-lg text-center">
 ...
 <div className="relative border-2 border-dashed border-slate-200 rounded-xl p-4 flex flex-col items-center justify-center gap-1.5 cursor-pointer bg-slate-50/50">
 <input
 type="file"
 accept="image/*"
 ...
 type="submit"
 disabled={loading}
 className="flex-1 bg-primary text-white font-bold py-3.5 rounded-xl text-xs shadow-sm touch-target flex items-center justify-center cursor-pointer"
 >
